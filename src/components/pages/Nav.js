...
import {MdOutlineShoppingBag} from 'react-icons/md'
 ...
 const Nav = () => {
    ...
    const{totalItems,addItem, cartTotal}=useCart();
    return (
        <header>
            <div className="head1 pt-1">
                <div className="container  d-flex justify-content-between align-items-center">
                    ...
                    <div className="text2 d-flex justify-content-between align-items-center">
                        <p className='p'>Store Locator</p>
                        <p className='p'>Track Your Order</p>
                        <NavLink to='/card' className='p mb-3'>Shop</NavLink>
                        <NavLink to='/account' className='p mb-3'>My Account</NavLink>
                        <p>Switch to RTL</p>
                    </div>
                </div>
            </div>
            <div className="head2">
                <div className="container d-flex align-items-center justify-content-between">
                    <div className='logo d-flex align-items-center justify-content-between'>
                        <svg to="/" exact version="1.1" x="0px" y="0px" width="175.748px" height="42.52px" viewBox="0 0 175.748 42.52" enable-background="new 0 0 175.748 42.52">
...
c5.976-0.568,9.574-3.936,11.816-8.354c-0.141-0.271-0.221-0.604-0.336-0.902C92.929,31.364,90.843,30.485,88.812,29.55z"></path>
                    ...
                    <div className="search">
                        <form className='d-flex align-items-center justify-content-between'>
                            ...
                            <select name="" id="">
                                 ...
                                 <option>Video Games & Tablets</option>
                    ...
                    <div className="icons d-flex align-items-center justify-content-between">
                        <BiGitCompare className='icon icon1'/>
                        <BsHeart className='icon icon2'/>
...
c5.976-0.568,9.574-3.936,11.816-8.354c-0.141-0.271-0.221-0.604-0.336-0.902C92.929,31.364,90.843,30.485,88.812,29.55z"></path>
                ...
                >  
                    <NavLink to='/' className="link"  activeClassName="active" exact ><li>Home</li></NavLink>
                    <NavLink to='/about'  className="link"  activeClassName="active" ><li>About Us</li></NavLink>
                    <NavLink to='/contact'  className="link"  activeClassName="active" ><li>Contact Us</li></NavLink>
                    <NavLink to='/blogs'  className="link"  activeClassName="active" ><li>Blog</li></NavLink>
                    <NavLink to='/allproducts'  className="link"  activeClassName="active" ><li>All Products</li></NavLink>
